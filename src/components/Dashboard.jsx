...
const GigCard = ({ item, userRole, isAlreadyApplied, onApply, navigate }) => (
    <div className="p-5 bg-slate-900/50 border border-white/5 rounded-2xl flex justify-between items-center hover:border-blue-500/30 transition-all">
        <div>
            <span className="px-2 py-0.5 bg-blue-500/10 text-blue-400 text-[8px] font-bold rounded uppercase">{item.category}</span>
        ...
        >
            {/* Shimmer Effect (Sirf tab dikhega jab applied na ho) */}
            {!isAlreadyApplied && (
